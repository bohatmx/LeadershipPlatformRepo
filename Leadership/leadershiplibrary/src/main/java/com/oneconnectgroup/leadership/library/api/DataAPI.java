...
import com.oneconnectgroup.leadership.library.data.CategoryDTO;
import com.oneconnectgroup.leadership.library.data.CountryDTO;
import com.oneconnectgroup.leadership.library.data.DailyThoughtDTO;
import com.oneconnectgroup.leadership.library.data.EBookDTO;
import com.oneconnectgroup.leadership.library.data.PhotoDTO;
import com.oneconnectgroup.leadership.library.data.PodcastDTO;
import com.oneconnectgroup.leadership.library.data.ResponseBag;
import com.oneconnectgroup.leadership.library.data.SubscriberDTO;
import com.oneconnectgroup.leadership.library.data.VideoDTO;
import com.oneconnectgroup.leadership.library.data.WeeklyMasterClassDTO;
import com.oneconnectgroup.leadership.library.data.WeeklyMessageDTO;
...
public class DataAPI {
    ...
    public interface OnUserCreated {
        void onResponse(SubscriberDTO user);
    ...
    public void createSubscriber(final SubscriberDTO user, final Context ctx,
        ...
        try {
            ...
            authResultTask.addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                ...
                public void onSuccess(AuthResult authResult) {
                    ...
                    addUser(user, ctx, new DataListener() {
                        @Override
                        public void onResponse(String key) {
                            Log.i(TAG, "+++++++++ onResponse: user added: " + key);
                            user.setSubscriberID(key);
    ...
    public void getUserByEmail(final String email, final OnDataRead listener) {
        ...
        q.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                b.setSubscribers(new ArrayList<SubscriberDTO>());
                ...
                for (DataSnapshot shot : dataSnapshot.getChildren()) {
                    SubscriberDTO u = shot.getValue(SubscriberDTO.class);
    ...
    public void addUser(final SubscriberDTO c, final Context ctx, final DataListener listener) {
        ...
        userRef.push().setValue(c, new DatabaseReference.CompletionListener() {
            ...
            public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                if (databaseError == null) {
                    ...
                    c.setSubscriberID(databaseReference.getKey());
