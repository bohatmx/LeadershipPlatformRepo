package com.oneconnect.leadership.subscriber.services;
...
import com.oneconnect.leadership.subscriber.NotifHandlerActivity;
import com.oneconnect.leadership.subscriber.R;

import java.util.List;
import java.util.Map;

public class SubscriberMessagingService extends FirebaseMessagingService {
    public SubscriberMessagingService() {
    }

    public static final String TAG = SubscriberMessagingService.class.getSimpleName(),
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        boolean isRunning = isMainActivityRunning("com.oneconnect.leadership.subscriber");
        Log.w(TAG, "onMessageReceived: com.oneconnect.leadership.subscriber isRunning: " + isRunning );
