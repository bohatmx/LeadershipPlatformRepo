...
public class CompanyMainActivity extends AppCompatActivity implements CrudContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        card2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Util.flashOnce(card2, 300, new Util.UtilAnimationListener() {
                    @Override
                    public void onAnimationEnded() {
                        Intent intent = new Intent(CompanyMainActivity.this, VideoSelectionActivity.class);
        ...
        companyThoughts = (TextView) findViewById(R.id.companyThoughts);
        companyVideos = (TextView) findViewById(R.id.companyVideos);
        companyUsers = (TextView) findViewById(R.id.companyUsers);
        companyPodcasts = (TextView) findViewById(R.id.companyPodcasts);
