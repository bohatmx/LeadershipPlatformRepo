...
public class ApproveThoughts extends AppCompatActivity implements CrudContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_approve_thoughts);
        ...
        pendingRecyclerView = (RecyclerView) findViewById(com.oneconnect.leadership.library.R.id.pendingRecyclerView);
    ...
    public void onPendingDailyThoughts(List<DailyThoughtDTO> list) {
        ...
        adapter = new ApprovalThoughtAdapter(ctx, list, new ApprovalThoughtAdapter.ApprovalThoughtAdapterlistener() {
            ...
            public void onThoughtSelected(DailyThoughtDTO dailyThought) {
                Intent intent = new Intent(ApproveThoughts.this, ApproveEntityActivity.class);
    ...
    static final String LOG = ApproveThoughts.class.getSimpleName();
