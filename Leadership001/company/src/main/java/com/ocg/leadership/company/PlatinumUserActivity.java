...
public class PlatinumUserActivity extends AppCompatActivity implements  NavigationView.OnNavigationItemSelectedListener,
    ...
    private int type;
    NavigationView platinum_nav_view;
    private PagerAdapter adapter;
    private PlatinumUserActivity activity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_platinum_user);
    ...
    public void onPodcastsSelected() {
        Intent intent = new Intent(PlatinumUserActivity.this, PodcastSelectionActivity.class);
        intent.putExtra("user", user);
        startActivity(intent);
    }
        ...
        platinum_nav_view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (item.getItemId() == R.id.nav_sign_out) {
                    ...
                    Intent intent = new Intent(PlatinumUserActivity.this, CompanySigninActivity.class);
                    startActivity(intent);
                    finish();
                    return true;
                }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_internal) {
            ...
            Intent intent = new Intent(PlatinumUserActivity.this, PlatinumUserActivity.class);
            intent.putExtra("type", type);
            startActivity(intent);
        }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        int id = item.getItemId();
            ...
            if (id == R.id.nav_daily_thought) {
                ...
                Intent intent = new Intent(PlatinumUserActivity.this, PodcastActivity.class);
                startActivity(intent);
                return true;
            ...
            return true;
                ...
                Intent intent = new Intent(PlatinumUserActivity.this, eBookActivity.class);
                startActivity(intent);
                return true;
            }
        drawer = (DrawerLayout) findViewById(R.id.drawer_layout);
