...
public class VideoPlayerActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // mediaDataSourceFactory = buildDataSourceFactory(true);
        ...
        setContentView(R.layout.activity_le_exo_player);
        /*Intent intent = getIntent();*/
       // HashMap<String, VideoDTO> hashMap = (HashMap<String, VideoDTO>) intent.getSerializableExtra("bag");
...
//            debugViewHelper = null;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.le_exo_player, menu);
        return true;
    }
    ...
    public void onTracksChanged(TrackGroupArray trackGroups, TrackSelectionArray trackSelections) {
        ...
        if (mappedTrackInfo != null) {
            if (mappedTrackInfo.getTrackTypeRendererSupport(C.TRACK_TYPE_VIDEO)
                ...
                showSnackbar(getString(R.string.error_unsupported_video), "OK", "red");
            }
            if (mappedTrackInfo.getTrackTypeRendererSupport(C.TRACK_TYPE_AUDIO)
                    == MappingTrackSelector.MappedTrackInfo.RENDERER_SUPPORT_UNSUPPORTED_TRACKS) {
                showSnackbar(getString(R.string.error_unsupported_audio), "bad", "red");
            }
        }
    }
    ...
    public static final String TAG = LeExoPlayerActivity.class.getSimpleName();
