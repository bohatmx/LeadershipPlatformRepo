...
public class TextViewExpandableAnimation extends LinearLayout
    ...
    private void initValue(Context context, AttributeSet attrs) {
        ...
        textContentColor = ta.getColor(R.styleable.TextViewExpandableAnimation_tvea_textContentColor, ContextCompat.getColor(context, R.color.black));
        textContentSize = ta.getDimension(R.styleable.TextViewExpandableAnimation_tvea_textContentSize, 15);
