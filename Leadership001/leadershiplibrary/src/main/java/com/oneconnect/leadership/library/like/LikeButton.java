...
public class LikeButton extends FrameLayout implements View.OnClickListener {
     ...
     * set in xml and inflating the com.oneconnect.leadership.library.like button's view and initial state.
     *
     * @param context
     * @param attrs
     * @param defStyle
     ...
     * the com.oneconnect.leadership.library.like effect are also updated to reflect the size of the icon.
     *
     * @param iconSize
     */
     ...
     * that will be exploding once the com.oneconnect.leadership.library.like button is clicked.
     *
     * @param primaryColor
    ...
    /**
     * Returns current com.oneconnect.leadership.library.like state
     *
     * @return current com.oneconnect.leadership.library.like state
     */
